...
abstract class $PostEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String name, String? content, String? preContent});
}
...
class _$_PostEntity implements _PostEntity {
  const _$_PostEntity(
      {required this.id, required this.name, this.content, this.preContent});
  ...
  @override
  String toString() {
    return 'PostEntity(id: $id, name: $name, content: $content, preContent: $preContent)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, content, preContent);
...
abstract class _PostEntity implements PostEntity {
  const factory _PostEntity(
      ...
      final String? content,
      final String? preContent}) = _$_PostEntity;
